...
public class WorldGenMysticRuins extends WorldGenerator
{
    public WorldGenMysticRuins()
    {
    }
    ...
    public boolean generate(World world, Random random, int i, int j, int k)
    {
        ...
        for (int i1 = 0; i1 < 1; i1++)
        {
            ...
            if (i2 == 1)
            {
                ...
                world.setBlock(j1 + 1, (k1 - j5) + 5, l1 + 1, Block.stone.blockID);
                world.setBlock(j1 + 1, (k1 - j5) + 4, l1 + 1, MysticRuins.vines.blockID);
                world.setBlock(j1 + 1, (k1 - j5) + 3, l1 + 1, MysticRuins.vines.blockID);
                world.setBlock(j1 + 1, (k1 - j5) + 2, l1 + 1, 0);
                world.setBlock(j1, k1 - j5 - k4, l1 + 2, MysticRuins.treasureIron.blockID);
                ...
                world.setBlock(j1 + l3, ((k1 - j5) + 3) - i6, l1 + l3 + 6, Block.cobblestone.blockID);
                world.setBlock(j1 + l3, ((k1 - j5) + 4) - i6, l1 + l3 + 6, Block.cobblestoneMossy.blockID);
                world.setBlock(j1 + l3, ((k1 - j5) + 5) - i6, l1 + l3 + 6, Block.cobblestone.blockID);
                world.setBlock(j1 + l3, ((k1 - j5) + 6) - i6, l1 + l3 + 6, Block.cobblestoneMossy.blockID);
                ...
                world.setBlock(j1 + l3, ((k1 - j5) + 3) - i6, l1 + l3 + 7, Block.cobblestoneMossy.blockID);
                world.setBlock(j1 + l3 + 1, ((k1 - j5) + 6) - i6, l1 + l3 + 6, Block.stone.blockID);
                world.setBlock(j1 + l3 + 1, ((k1 - j5) + 5) - i6, l1 + l3 + 6, MysticRuins.vines.blockID);
                world.setBlock(j1 + l3 + 1, ((k1 - j5) + 4) - i6, l1 + l3 + 6, MysticRuins.vines.blockID);
                world.setBlock(j1 + l3 + 1, ((k1 - j5) + 3) - i6, l1 + l3 + 6, 0);
                k7 = random.nextInt(100);

                if (k7 <= 30)
                {
                    world.setBlock(j1 + l3, k1 - j5 - i6 - k4, l1 + l3 + 5, MysticRuins.treasureGold.blockID);
                ...
                if (k7 <= 60)
                {
                    world.setBlock(j1 - i3 - 1, k1 - j5 - i6 - k4, l1 - 5, MysticRuins.treasureIron.blockID);
            ...
            if (i2 == 2)
            {
                ...
                world.setBlock(j1, k1 - k5 - l4, l1 + 2, MysticRuins.treasureIron.blockID);
                ...
                world.setBlock(j1 - k2, ((k1 - k5) + 3) - j6, l1 - 5, Block.cobblestone.blockID);
                world.setBlock(j1 - k2, ((k1 - k5) + 4) - j6, l1 - 5, Block.cobblestoneMossy.blockID);
                world.setBlock(j1 - k2, ((k1 - k5) + 5) - j6, l1 - 5, Block.cobblestoneMossy.blockID);
                ...
                world.setBlock((j1 - k2) + 1, ((k1 - k5) + 5) - j6, l1 - 5, Block.stone.blockID);
                world.setBlock((j1 - k2) + 1, ((k1 - k5) + 4) - j6, l1 - 5, MysticRuins.vines.blockID);
                world.setBlock((j1 - k2) + 1, ((k1 - k5) + 3) - j6, l1 - 5, MysticRuins.vines.blockID);
                world.setBlock((j1 - k2) + 1, ((k1 - k5) + 2) - j6, l1 - 5, 0);
                l7 = random.nextInt(100);

                if (l7 <= 30)
                {
                    world.setBlock(j1 - k2 - 1, k1 - k5 - j6 - l4, l1 - 5, MysticRuins.treasureGold.blockID);
                ...
                if (l7 <= 60)
                {
                    world.setBlock(j1 + i4, k1 - k5 - j6 - l4, l1 + 7, MysticRuins.treasureIron.blockID);
                ...
                world.setBlock(j1 - j3 - 1, ((k1 - k5) + 5) - j6, (l1 + i4) - 2, Block.stone.blockID);
                world.setBlock(j1 - j3 - 1, ((k1 - k5) + 4) - j6, (l1 + i4) - 2, MysticRuins.vines.blockID);
                world.setBlock(j1 - j3 - 1, ((k1 - k5) + 3) - j6, (l1 + i4) - 2, MysticRuins.vines.blockID);
                world.setBlock(j1 - j3 - 1, ((k1 - k5) + 2) - j6, (l1 + i4) - 2, 0);
                l7 = random.nextInt(100);

                if (l7 <= 30)
                {
                    world.setBlock(j1 - j3, k1 - k5 - j6 - l4, (l1 + i4) - 2, MysticRuins.treasureGold.blockID);
                ...
                if (l7 <= 30)
                {
                    world.setBlock(j1 + j3 + 4, k1 - k5 - j6 - l4, l1 - 7, MysticRuins.treasureGold.blockID);
            ...
            world.setBlock(j1 + 1, (k1 - l5) + 6, l1, Block.stone.blockID);
            world.setBlock(j1 + 1, (k1 - l5) + 5, l1, MysticRuins.vines.blockID);
            world.setBlock(j1 + 1, (k1 - l5) + 4, l1, MysticRuins.vines.blockID);
            world.setBlock(j1 + 1, (k1 - l5) + 3, l1, 0);
            world.setBlock(j1, k1 - l5 - i5, l1 + 1, MysticRuins.treasureIron.blockID);
            ...
            if (i8 <= 30)
            {
                world.setBlock(j1 + k3 + l2, k1 - l5 - k6 - i5, l1 + j4 + 1, MysticRuins.treasureGold.blockID);
            ...
            if (i8 <= 60)
            {
                world.setBlock(j1 - k3 - 1, k1 - l5 - k6 - i5, l1 - l2 - 6, MysticRuins.treasureIron.blockID);
            ...
            if (i8 <= 30)
            {
                world.setBlock(j1 + l2 + 2, k1 - l5 - k6 - i5, l1 + j4, MysticRuins.treasureGold.blockID);
            ...
            if (i8 <= 30)
            {
                world.setBlock(j1 - 3, k1 - l5 - k6 - i5, l1 + k3 + 3, MysticRuins.treasureGold.blockID);
