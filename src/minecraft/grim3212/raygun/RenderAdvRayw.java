...
public class RenderAdvRayw extends Render {

   private int itemIconIndex;


   public RenderAdvRayw(int var1) {
   ...
   public void doRender(Entity var1, double var2, double var4, double var6, float var8, float var9) {
      ...
      this.loadTexture("/mods/Raygun/textures/entities/sonicAdv.png");
      Tessellator var10 = Tessellator.instance;
      float var11 = (float)(this.itemIconIndex % 16 * 16 + 0) / 16.0F;
      float var12 = (float)(this.itemIconIndex % 16 * 16 + 16) / 16.0F;
      float var13 = (float)(this.itemIconIndex / 16 * 16 + 0) / 16.0F;
      float var14 = (float)(this.itemIconIndex / 16 * 16 + 16) / 16.0F;
      float var15 = 1.0F;
      float var16 = 0.5F;
      float var17 = 0.25F;
      ...
      var10.setNormal(1.0F, 1.0F, 1.0F);
