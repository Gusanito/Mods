...
public class EntityRayw extends Entity {
   ...
   public EntityRayw(World var1, EntityLiving var2) {
      super(var1);
   ...
   public EntityRayw(World var1, double var2, double var4, double var6) {
      super(var1);
      this.field_810_h = 0;
      this.setSize(0.2F, 0.2F);
      ...
      if(var3 != null) {
         if(var3.entityHit != null) {
            ...
            if(this.shootingEntity == null) {
               ...
               if(!var3.entityHit.attackEntityFrom(var17, 10)) {
                  ;
               }
            } else {
