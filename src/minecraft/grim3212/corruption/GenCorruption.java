...
public class GenCorruption extends WorldGenerator {

	private int blockID;
	private int numberOfBlocks;

	public GenCorruption(int var1, int var2) {
		super();
		this.blockID = var2;
			...
			for (int var32 = (int) (var20 - var28 / 2.0D); var32 <= (int) (var20 + var28 / 2.0D); ++var32) {
				for (int var33 = (int) (var22 - var30 / 2.0D); var33 <= (int) (var22 + var30 / 2.0D); ++var33) {
					for (int var34 = (int) (var24 - var28 / 2.0D); var34 <= (int) (var24 + var28 / 2.0D); ++var34) {
						...
						if (var35 * var35 + var37 * var37 + var39 * var39 < 1.0D && var1.getBlockId(var32, var33 + 1, var34) == 87) {
							var1.setBlock(var32, var33, var34, this.blockID);
							var1.setBlock(var32 - 1, var33, var34, this.blockID);
							var1.setBlock(var32, var33, var34 - 1, this.blockID);
							var1.setBlock(var32 - 1, var33, var34 - 1, this.blockID);
						}
					}
				}
			}
