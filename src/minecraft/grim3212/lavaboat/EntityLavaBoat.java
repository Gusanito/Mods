    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, int par2)
    {
        ...
        else if (!this.worldObj.isRemote && !this.isDead)
        {
            ...
            if (flag || this.getDamageTaken() > 40)
            {
                ...
                if (!flag)
                {
                    this.dropItemWithOffset(LavaBoat.LavaBoat.itemID, 1, 0.0F);
                }
        ...
        if (d3 > 0.26249999999999996D)
        {
            ...
            for (int j = 0; (double)j < 1.0D + d3 * 60.0D; ++j)
            {
                ...
                if (this.rand.nextBoolean())
                {
                    ...
                    this.worldObj.spawnParticle("lavapop", d8, this.posY - 0.125D, d9, this.motionX, this.motionY, this.motionZ);
                }
                else
                {
        ...
        else
        {
            ...
            if (this.isCollidedHorizontally && d3 > 0.2D)
            {
                if (!this.worldObj.isRemote)
                {
                    ...
                    for (k = 0; k < 3; ++k)
                    {
                        this.dropItemWithOffset(Block.cobblestone.blockID, 1, 0.0F);
                    }
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        else
        {
            ...
            if(this.riddenByEntity == par1EntityPlayer){
            	par1EntityPlayer.addPotionEffect(new PotionEffect(Potion.fireResistance.id, 100000, 2));
            }else{
            	par1EntityPlayer.extinguish();
            	par1EntityPlayer.removePotionEffect(Potion.fireResistance.id);
            }
