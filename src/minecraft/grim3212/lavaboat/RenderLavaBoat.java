...
public class RenderLavaBoat extends Render
{
     ...
     */
    public void renderBoat(EntityLavaBoat par1EntityBoat, double par2, double par4, double par6, float par8, float par9)
    {
        GL11.glPushMatrix();
        ...
        this.loadTexture("/mods/LavaBoat/textures/render/lavaboat.png");
    ...
    {
        this.renderBoat((EntityLavaBoat)par1Entity, par2, par4, par6, par8, par9);
    }
}
