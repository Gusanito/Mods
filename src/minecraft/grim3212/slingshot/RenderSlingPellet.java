...
public class RenderSlingPellet extends RenderSnowball
{
	/**
    ...
    public RenderSlingPellet(Item par1, int par2) {
		super(par1, par2);
    ...
    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        this.loadTexture("/mods/Slingshot/textures/items/slingpellet.png");
