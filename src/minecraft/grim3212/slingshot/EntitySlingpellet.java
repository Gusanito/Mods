...
{
	public EntitySlingpellet(World par1World)
    {
        super(par1World);
    }

    public EntitySlingpellet(World par1World, EntityLiving par2EntityLiving)
    {
        super(par1World, par2EntityLiving);
    }

    public EntitySlingpellet(World par1World, double par2, double par4, double par6)
    {
