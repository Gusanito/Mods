...
public class EntityBKnife extends Entity {
   ...
   public void onUpdate() {
      ...
      if(this.inGround) {
         ...
         ++this.ticksInAir;
         Vec3 var17 = Vec3.fakePool.getVecFromPool(this.posX, this.posY, this.posZ);
         Vec3 var3 = Vec3.fakePool.getVecFromPool(this.posX + this.motionX, this.posY + this.motionY, this.posZ + this.motionZ);
         MovingObjectPosition var4 = this.worldObj.rayTraceBlocks_do_do(var17, var3, false, true);
         var17 = Vec3.fakePool.getVecFromPool(this.posX, this.posY, this.posZ);
         var3 = Vec3.fakePool.getVecFromPool(this.posX + this.motionX, this.posY + this.motionY, this.posZ + this.motionZ);
         if(var4 != null) {
            var3 = Vec3.fakePool.getVecFromPool(var4.hitVec.xCoord, var4.hitVec.yCoord, var4.hitVec.zCoord);
         }
         ...
         if(var4 != null) {
			...
			if(var4.entityHit.attackEntityFrom(damagesource, 7)) {
