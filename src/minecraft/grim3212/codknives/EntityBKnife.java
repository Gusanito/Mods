...
public class EntityBKnife extends Entity implements IProjectile {
   ...
   public EntityBKnife(World var1) {
      super(var1);
      this.renderDistanceWeight = 10.0D;
      this.setSize(0.5F, 0.5F);
   }

   public EntityBKnife(World var1, double var2, double var4, double var6) {
      super(var1);
      this.setSize(0.5F, 0.5F);
      this.renderDistanceWeight = 10.0D;
       ...
       else
       {
           ...
           if (movingobjectposition != null)
           {
               if (movingobjectposition.entityHit != null)
               {
                   ...
                   int i1 = MathHelper.ceiling_double_int((double)f2 * 7);
   ...
   public void onCollideWithPlayer(EntityPlayer var1) {
      if(!this.worldObj.isRemote) {
         if(this.inGround && this.doesArrowBelongToPlayer && this.arrowShake <= 0 && var1.inventory.addItemStackToInventory(new ItemStack(Knives.Bknife, 1))) {
