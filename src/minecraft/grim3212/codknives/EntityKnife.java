...
public class EntityKnife extends Entity implements IProjectile {
	...
	public EntityKnife(World var1) {
		super(var1);
		this.setSize(0.5F, 0.5F);
	}

	public EntityKnife(World var1, double var2, double var4, double var6) {
		super(var1);
		this.setSize(0.5F, 0.5F);
	...
	public EntityKnife(World var1, EntityLiving var2) {
		super(var1);
		this.owner = var2;
	...
	public void onCollideWithPlayer(EntityPlayer var1) {
		if (!this.worldObj.isRemote) {
			if (this.inGround && this.doesArrowBelongToPlayer && this.arrowShake <= 0 && var1.inventory.addItemStackToInventory(new ItemStack(Knives.knife, 1))) {
