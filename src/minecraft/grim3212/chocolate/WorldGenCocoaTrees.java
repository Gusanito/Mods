            ...
            for (int k3 = i - i3; k3 <= i + i3; k3++)
            {
                ...
                for (int i4 = k - i3; i4 <= k + i3; i4++)
                {
                    ...
                    if (random.nextInt(60) < 10)
                    {
                        ...
                        if (world.getBlockId(k3, k1 - 1, i4) == Chocolate.CocoaBlock.blockID)
                        {
                            world.setBlock(k3, k1, i4, 18);
                        }
                        else
                        {
                            world.setBlock(k3, k1, i4, Chocolate.CocoaBlock.blockID);
                            world.setBlock(k3, k1 + 1, i4, 18);
                        }
                    }
                    else
                    {
