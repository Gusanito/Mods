...
public class ItemBowlChocolate extends Item {
	...
	public ItemBowlChocolate(int i, int j) {
		super(i);
		maxStackSize = 1;
		a = j;
		if (a == 0) {
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer) {
		...
		if (movingobjectposition.typeOfHit == EnumMovingObjectType.TILE) {
			...
			if (world.getBlockId(i, j, k) == Chocolate.CBarMould.blockID && a == 1) {
	...
	public void updateIcons(IconRegister par1IconRegister) {
		if (itemID == Chocolate.BowlChocolate.itemID) {
			this.iconIndex = par1IconRegister.registerIcon("Chocolate:" + "bowl_chocolate");
		}
		if (itemID == Chocolate.BowlChocolateHot.itemID) {
			this.iconIndex = par1IconRegister.registerIcon("Chocolate:" + "bowl_chocolateh");
		}
	}
}
